...
#define MAIN_WINDOW_TITLE L"Castle_Vania"
...
void LoadResources()
{
	...
	textures->AddResources();


	CSprites * sprites = CSprites::GetInstance();
	CAnimations * animations = CAnimations::GetInstance();

	sprites->AddRersources();
	animations->AddResources();
	...
	for (int i = 0; i < 48; i++)
	{
		CBrick *brick = new CBrick();
		brick->AddAnimation(601);
		brick->SetPosition(0 + i*32.0f, SCREEN_HEIGHT-70.0f);
		objects.push_back(brick);
	}
